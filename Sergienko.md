...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: В одном документе слово может использоваться несколько раз.
```
...
```
# 3.4 Ответ: Потому что там можно искать только отдельные словоформы/лексемы.
```
...
```
# 5.1 Объем снятника: 6 003 398 слов
```
...
```
__Текст___: вс 3 167 354 вхождения  
__статус__: префикс   38 773 вхождений
```
